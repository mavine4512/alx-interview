...
solution = []
"""The list of posible solutions to the N queens problem.
"""
n = 0
...
def is_attacking(pos0, pos1):
    ...
    Return:
        bool: True if the queen are in an attacking position else False.
    """
    if (pos0[0] == pos[1]) or (pos0[1] == pos1[1]):
        return True
...
def group_exists(group):
    ...
    Args:
        group (list of integers): A group of posible positions.

    Returns:
        bools: True if it exists, otherwise false.
    """
    global solutions
...
def build_solution(row, group):
    ...
    Args:
        row (int): Then currect row int the chessboard.
        group (list of lists of int): the group of valid positions.
    """
    global solutions
    global n
    if row == n:
